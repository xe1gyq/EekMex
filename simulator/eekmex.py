...
def eekMexLogging():
    ...
    loggerFile = logging.FileHandler('eekmexbackup.log', 'a')
    loggerFile.setLevel(logging.INFO)

    loggerFileGoogleEarth = logging.FileHandler('eekmexprekml.log', 'a')
...
if __name__=='__main__':
    ...
    if args.clean == 'files':
        ...
        os.remove('eekmexbackup.log')
        os.remove('eekmexprekml.log')
